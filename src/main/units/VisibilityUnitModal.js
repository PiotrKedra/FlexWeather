  ...
  return (
    <CustomModal isVisible={isVisible} setVisible={setVisible} mainColor={theme.mainColor}>
      ...
      <Pressable style={{flexDirection: 'row', alignItems: 'center'}}
        ...
        onPress={() => {
          setWeatherUnits({...weatherUnits, visibility: METERS}); setVisible(false);
        }}>
      ...
      <Pressable style={{flexDirection: 'row', alignItems: 'center'}}
        android_ripple={{color: '#ddd'}}
        onPress={() => {
          setWeatherUnits({...weatherUnits, visibility: KILOMETERS}); setVisible(false);
        }}>
      ...
      <Pressable style={{flexDirection: 'row', alignItems: 'center'}}
        android_ripple={{color: '#ddd'}}
        onPress={() => {
          setWeatherUnits({...weatherUnits, visibility: MILES}); setVisible(false);
        }}>
