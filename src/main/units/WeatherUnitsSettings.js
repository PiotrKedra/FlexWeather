...
const WeatherUnitsSettings = ({theme, weatherUnits}) => {
  ...
  return (
    <View>
      <View style={[styles.mainLabel, {borderColor: theme.softBackgroundColor}]}>
      ...
      <Pressable style={styles.settingView}
        ...
        <Image
          ...
          source={require('../../../assets/images/details/temperature.png')}/>
        <View>
      ...
      <Pressable style={styles.settingView}
        ...
        <Image
          style={[styles.settingIcon, {tintColor: theme.iconColor}]}
          source={require('../../../assets/images/details/wind-speed.png')}/>
        <View>
      ...
      <Pressable style={styles.settingView}
        ...
        <Image
          style={[styles.settingIcon, {tintColor: theme.iconColor}]}
          source={require('../../../assets/images/details/clock.png')}/>
        <View>
...
const styles = StyleSheet.create({
  mainLabel: {flexDirection: 'row', borderBottomWidth: 1, alignItems: 'center'},
