  ...
  return (
    <CustomModal isVisible={isVisible} setVisible={setVisible} mainColor={theme.mainColor}>
      ...
      <Pressable style={{flexDirection: 'row', alignItems: 'center'}}
        ...
        onPress={() => {
          setWeatherUnits({...weatherUnits, wind: KILOMETERS_PER_HOUR}); setVisible(false);
        }}>
      ...
      <Pressable style={{flexDirection: 'row', alignItems: 'center'}}
        android_ripple={{color: '#ddd'}}
        onPress={() => {
          setWeatherUnits({...weatherUnits, wind: METERS_PER_SECOND}); setVisible(false);
        }}>
      ...
      <Pressable style={{flexDirection: 'row', alignItems: 'center'}}
        android_ripple={{color: '#ddd'}}
        onPress={() => {
          setWeatherUnits({...weatherUnits, wind: MILES_PER_HOUR}); setVisible(false);
        }}>
      ...
      <Pressable style={{flexDirection: 'row', alignItems: 'center'}}
        android_ripple={{color: '#ddd'}}
        onPress={() => {
          setWeatherUnits({...weatherUnits, wind: KNOT}); setVisible(false);
        }}>
      ...
      <Pressable style={{flexDirection: 'row', alignItems: 'center'}}
        android_ripple={{color: '#ddd'}}
        onPress={() => {
          setWeatherUnits({...weatherUnits, wind: BEAUFORT_SCALE}); setVisible(false);
        }}>
