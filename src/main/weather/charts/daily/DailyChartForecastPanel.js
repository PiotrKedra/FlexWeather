    ...
    <Fragment>
      ...
      <ScrollView style={styles.selectionView}
        ...
        <TouchableOpacity
          style={[
            ...
            (currentChart==='general') ?
              {backgroundColor: weatherTheme.mainColor} :
        ...
        <TouchableOpacity
          ...
          <AnimatedChartText
            selected={currentChart==='rainfall'}
            title={'rainfall'}
            unit={'mm'}
            selectedTextColor={weatherTheme.textColor}
            textColor={theme.mainText}/>
        ...
        <TouchableOpacity
          style={[
            styles.chartSelectionButton,
            (currentChart==='uv_index') ?
              {backgroundColor: weatherTheme.mainColor} :
              chartNotSelectedStyle, {marginRight: 30}]}
          onPress={() => setCurrentChart('uv_index')}>
          <AnimatedChartText
            selected={currentChart==='uv_index'}
            title={'uv index'}
            unit={'-'}
            selectedTextColor={weatherTheme.textColor}
            textColor={theme.mainText}/>
