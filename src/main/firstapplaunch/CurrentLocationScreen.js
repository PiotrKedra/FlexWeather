        ...
        <View style={{flex: 1}}>
          ...
          <Animated.View style={[styles.absoluteView, {left: this.state.searchingLeftPosition}]}>
            ...
            <View style={{flex: 1, justifyContent: 'center', paddingBottom: 20}}>
              <CustomText style={{fontSize: 35, color: theme.mainText, textAlign: 'center'}}>
                Hold on one second
              </CustomText>
              <CustomText style={{fontSize: 20, textAlign: 'center', color: theme.softText}}>
                Searching for your location, usually
              </CustomText>
              <CustomText style={{fontSize: 20, textAlign: 'center', color: theme.softText}}>
                {'it dosen\'t take a lot of time.'}
              </CustomText>
            </View>
          ...
          <Animated.View style={[styles.absoluteView, {left: this.state.resultLeftPosition}]}>
            ...
            <View style={{flex: 1, justifyContent: 'center', paddingBottom: 20}}>
              <CustomText style={{fontSize: 40, color: theme.mainText, textAlign: 'center'}}>
                {this.state.location.city}
              </CustomText>
              <CustomText style={{fontSize: 20, textAlign: 'center', color: theme.softText}}>
                If you would like to see forecast in
              </CustomText>
              <CustomText style={{fontSize: 20, textAlign: 'center', color: theme.softText}}>
                {this.state.location.city}, then accept it. If no, then
              </CustomText>
              <CustomText style={{fontSize: 20, textAlign: 'center', color: theme.softText}}>
                pick another.
              </CustomText>
