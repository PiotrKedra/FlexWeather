        ...
        <View style={{flex: 1, backgroundColor: this.state.theme.mainColor}}>
          <ScrollView>
            ...
            <View style={{justifyContent: 'center', marginLeft: '10%', paddingBottom: 20, marginTop: 20}}>
              ...
              <CustomText style={{fontSize: 20, color: this.state.theme.softText}}>
                or keep default, you can change it later.
              </CustomText>
            </View>
            <View style={{justifyContent: 'center', paddingHorizontal: '10%'}}>
              ...
              <Pressable style={styles.settingView}
                onPress={() => {
                  this.props.navigation.navigate('SetupUnitsScreen'); BackHandler.removeEventListener('hardwareBackPress', this.state.onBackPress);
                }}
                android_ripple={{color: '#ddd'}}>
