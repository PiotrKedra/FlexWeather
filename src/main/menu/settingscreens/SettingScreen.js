  ...
  return (
    <ScrollView style={{backgroundColor: theme.mainColor, paddingHorizontal: '10%'}}>
      <View style={{marginTop: 30}}>
        <View style={[styles.notification, {borderColor: theme.softBackgroundColor}]}>
        ...
        <Pressable style={styles.settingView}
          ...
          <Image
            style={[styles.settingIcon, {tintColor: theme.iconColor}]}
      ...
      <View style={{marginBottom: 30}}>
        <View>
          <CustomText style={[styles.weatherText, {borderColor: theme.softBackgroundColor}]}>
            weather
          </CustomText>
        </View>
        <Pressable style={styles.settingView}
          ...
          <Image
            style={[styles.settingIcon, {tintColor: theme.iconColor}]}
            source={require('../../../../assets/images/icons/provider.png')}/>
          <View>
...
const styles = StyleSheet.create({
  notification: {flexDirection: 'row', borderBottomWidth: 1, alignItems: 'center'},
  settingView: {flexDirection: 'row', alignItems: 'center', marginTop: 20, borderRadius: 10},
  weatherText: {fontSize: 20, color: '#2c82c9', paddingBottom: 5, borderBottomWidth: 1},
