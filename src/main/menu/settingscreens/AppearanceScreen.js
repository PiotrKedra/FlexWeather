...
import {Dimensions, StyleSheet, View, ScrollView, Text, TouchableOpacity, ToastAndroid, Pressable, Image}
  from 'react-native';
        ...
        <ScrollView style={[styles.scrollView, {backgroundColor: this.state.mainColor}]}>
          <View style={[styles.sectionView, {borderColor: this.state.softBackgroundColor}]}>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <Image
                style={[styles.titleImage, {tintColor: this.state.iconColor}]}
            ...
            <Pressable style={styles.pressable}
              ...
              <Text style={[
                styles.eleText,
                this.state.themeId==='light' ? selectedEleTextStyle : nonSelectedEleTextStyle]}
              >
                light theme
              </Text>
            </Pressable>
            <Pressable style={styles.pressable}
              ...
              <Text style={[
                styles.eleText,
                this.state.themeId==='dark' ? selectedEleTextStyle : nonSelectedEleTextStyle]}
              >
                dark theme
              </Text>
            </Pressable>
            <Pressable style={styles.pressable}
              ...
              <Text style={[
                styles.eleText,
                this.state.themeId==='system' ? selectedEleTextStyle : nonSelectedEleTextStyle]}
              >
          ...
          <View style={[styles.sectionView, {borderColor: this.state.softBackgroundColor}]}>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <Image
                style={[styles.titleImage, {tintColor: this.state.iconColor}]}
                source={require('../../../../assets/images/icons/font.png')}/>
          ...
          <View style={styles.saveView}>
            <TouchableOpacity style={[styles.saveButton, this.isThemeChanged() ? {backgroundColor: '#2C82C9'} : null]}
              ...
              <Text style={[
                styles.saveText,
                {color: this.isThemeChanged() ? this.state.mainColor : this.state.softTextColor}]}
              >
                save
              </Text>
            </TouchableOpacity>
