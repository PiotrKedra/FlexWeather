    ...
    renderLocationItem(location, saveToHistory=false){
        return (
            ...
            >
                ...
                />
                <CustomText style={[styles.locationItemText, {color: this.props.theme.mainText}]}>{location.city}, {location.country}</CustomText>
            </TouchableOpacity>
        )
    }
                ...
                <View style={styles.overflowView}>
                    <View style={styles.locationSearchViewInner}>
                        ...
                        <TouchableOpacity style={styles.locationSearchCancelButton}
                                          onPress={() => {this.setState({locationInput: '', locations: []})}}
                        >
                            <Image
